...
/*问题反馈*/
export const showProblemList = (params) => {
    return axios.get('/gov/entData/showProblemList', params);
}
/*问题反馈--详情*/
export const problemDetail = (params) => {
    let url = '/ent/problem/problemDetail';
    return  axios.request({url,params})
}
export const starComment = (params) => {
    let url = '/ent/problem/starComment';
    return  axios.request({url,params})
}
