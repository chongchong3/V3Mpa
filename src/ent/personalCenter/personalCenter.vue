            ...
            <div class="main_box">
                <div class="main_box_center">
                    ...
                    <div class="main_box_table">
                        ...
                        <div class="table">
                            <div class="changPsd" @click="dialogVisible = true">
                                修改>
                            </div>
                            <div class="change_num" @click="diaChangNum = true">
                                修改>
                            </div>
                            <div
                                class="table-list"
                ...
                >
                    ...
                    <span slot="footer" class="dialog-footer">
                        ...
                        <el-button type="primary" @click="editNum"
                            >确定</el-button
                        >
                    </span>
                </el-dialog>
...
export default {
    ...
    methods: {
        ...
        //修改电话号码
        editNum() {
            modifyByPhone({ phone: this.input_num }).then(res => {
                if ((res.code == "0000")) {
                    this.$message.success("号码修改成功");
                    this.setdata.mobile = this.input_num
                    this.diaChangNum = false;
